                ...
                @if($category->exists && $currentUser->can('delete', $category))
                    <div class="pull-right">
                        <a href="#" data-toggle="modal" data-target="#delete-confirmation"
                           ...
                           data-modal-body="{{ trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/categories::common.category'), 'identifier' => strip_tags($category->name)]) }}"
