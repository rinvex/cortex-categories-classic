...
class ActivateCommand extends AbstractModuleCommand
{
     ...
     * @var string
     */
    protected $signature = 'cortex:activate:categories {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Activate Cortex Categories Module';
