...
class UnloadCommand extends AbstractModuleCommand
{
     ...
     * @var string
     */
    protected $signature = 'cortex:unload:categories {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Unload Cortex Categories Module';
