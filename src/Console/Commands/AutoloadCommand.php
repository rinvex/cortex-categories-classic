...
class AutoloadCommand extends AbstractModuleCommand
{
     ...
     * @var string
     */
    protected $signature = 'cortex:autoload:categories {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Autoload Cortex Categories Module';
