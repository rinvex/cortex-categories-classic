...
class CategoriesController extends AuthorizedController
{
    ...
    protected function process(FormRequest $request, Category $category)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/categories::common.category'), 'identifier' => strip_tags($category->name)])],
        ]);
    }
    ...
    public function destroy(Category $category)
    {
        ...
        return intend([
            'url' => route('adminarea.categories.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/categories::common.category'), 'identifier' => strip_tags($category->name)])],
        ]);
    }
}
